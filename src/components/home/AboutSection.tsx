        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 order-2 lg:order-1 animate-fade-in-up">
            <div className="relative p-6 bg-slate-900/80 border border-white/10 rounded-2xl shadow-2xl overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/10 to-blue-500/10 opacity-30" />
              <div className="absolute inset-0 grid-pattern opacity-10" />
              
              {/* Laptop Style Frame */}
              <div className="rounded-xl overflow-hidden border border-white/10 bg-slate-955 p-1 relative z-10">
                ...
                <div className="aspect-video bg-dark p-5 flex flex-col justify-between">
                  {/* Top Stats Overview */}
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="bg-slate-900 border border-white/5 rounded-lg p-2.5 flex flex-col justify-between shadow-md">
                      ...
                      <div className="text-[7px] text-primary font-semibold mt-0.5">On Schedule</div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 bg-slate-900/60 border border-white/5 rounded-xl p-3 flex flex-col justify-between mt-3">
                    ...
                    <div className="flex items-end gap-1.5 h-16 pt-2">
                      <div className="w-full h-8 bg-primary/30 rounded-t-sm hover:bg-primary/50 transition-colors"></div>
                      <div className="w-full h-12 bg-primary rounded-t-sm hover:bg-primary/80 transition-colors"></div>
                      <div className="w-full h-10 bg-primary/30 rounded-t-sm hover:bg-primary/50 transition-colors"></div>
                      <div className="w-full h-16 bg-primary rounded-t-sm hover:bg-primary/80 transition-colors"></div>
                      <div className="w-full h-14 bg-primary/30 rounded-t-sm hover:bg-primary/50 transition-colors"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-6 text-left order-1 lg:order-2">
            ...
            <Link
              href="/about"
              className="btn-glow bg-primary text-white px-8 py-3.5 rounded-full text-sm font-bold hover:bg-blue-600 transition-all inline-flex items-center justify-center whitespace-nowrap btn-active"
            >
              Read More
            </Link>
          </div>
