...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* Top Info Bar */}
        <div className="bg-[#0f172a]/80 border-b border-white/5 text-xs text-[#94a3b8] py-2 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center font-black text-white text-lg shadow-lg shadow-cyan-500/30">
                C
              </div>
            ...
            <button
              ...
              className="lg:hidden text-[#cbd5e1] hover:text-white p-2"
          ...
          <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-4">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-[#cbd5e1] hover:text-white transition-colors font-semibold py-2 border-b border-white/5 text-sm"
            ...
            <Link
              href="/contact"
              className="mt-2 btn-glow bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-3 rounded-full text-center font-bold text-sm"
              onClick={() => setMenuOpen(false)}
            >
              Get a Quote
            </Link>
