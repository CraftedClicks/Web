          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <a href="mailto:hello@craftedclicks.com" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium group-hover:text-cyan-400 transition-colors">hello@craftedclicks.com</div>
                  </div>
                </a>
                <a href="tel:+15551234567" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium group-hover:text-cyan-400 transition-colors">+1 (555) 123-4567</div>
                  </div>
                </a>
